...
const Page404 =()=>{
    ...
    return(
        ...
        <h2 className="text-3xl font-bold mt-5 text-emerald-800">¡Ups! Parece que aún no has iniciado sesión.
        ¡Crea una cuenta para iniciar sesión y poder crear notas!</h2>
